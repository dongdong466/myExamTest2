...
<table width="778" border="0" align="center" cellspacing="0" cellpadding="0">
 ...
 <table width="100%" height="265"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="12%">&nbsp;</td>
    <td width="77%" align="center" valign="top"><strong>真的准备好了吗？<br><br>考生单击“开始考试”按钮，系统将立即记录本次考试并登记考试成绩！</strong></td>
    <td width="11%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="center" valign="top"><html:button property="button" styleClass="btn_grey" value="开始考试" onclick="window.opener=null;window.close();window.open('/manage/startExam.do?action=startExam','','width=786,height=768,scrollbars=1');"/>
